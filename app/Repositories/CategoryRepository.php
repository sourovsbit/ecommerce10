...
class CategoryRepository implements CategoryInterface {
    ...
    public function index($datatable)
    {
        if($datatable == 1)
        {
            $data = Category::where('store_id',Session::get('store_id'))->get();
    ...
    {
        $params['item'] = ProductItem::where('store_id',Session::get('store_id'))->where('status',1)->get();
    ...
    public function status($id)
    {
        ...
        ActivityLog::create([
            ...
            'description_bn' => 'একটি ক্যাটাগরি এর স্ট্যাটাস পরিবর্তন করেছেন যার নাম '.$check->category_name_bn,
        ]);
        History::create([
            'tag' => 'category',
            'fk_id' => $id,
