        ...
        <form method="post" action="{{ route('unit.store') }}">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <input type="text" class="form-control form-control-sm @error('unit_name') is-invalid @enderror" id="unit_name" name="unit_name" value="{{ old('unit_name') }}">
                    @error('unit_name')
                ...
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <input type="text" class="form-control form-control-sm @error('unit_name_bn') is-invalid @enderror" id="unit_name_bn" name="unit_name_bn" value="{{ old('unit_name_bn') }}">
                    @error('unit_name_bn')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
