        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-6">
                ...
                <select class="form-control form-control-sm js-example-basic-single" name="cat_id" id="cat_id">
                    <option value="">@lang('common.select_one')</option>
                    @if(isset($data['cat']))
                    @foreach ($data['cat'] as $i)
                    <option
                    @if($data['data']->cat_id == $i->id)
                    selected
                    @endif
                    value="{{ $i->id }}">
                        @if(config('app.locale') == 'en')
                        {{ $i->category_name ?: $i->category_name_bn }}
                        @elseif(config('app.loale') == 'bn')
                        {{ $i->category_name_bn ?: $i->category_name }}
                        @endif
                    </option>
                    @endforeach
                    @endif
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <input type="text" class="form-control form-control-sm @error('product_name') is-invalid @enderror" id="product_name" name="product_name" value="{{ $data['data']->product_name }}">
                @error('product_name')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <input type="text" class="form-control form-control-sm @error('product_name_bn') is-invalid @enderror" id="product_name_bn" name="product_name_bn" value="{{ $data['data']->product_name_bn }}">
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <input type="number" class="form-control form-control-sm @error('purchase_price') is-invalid @enderror" id="purchase_price" name="purchase_price" value="{{ $data['data']->purchase_price }}">
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <input type="number" class="form-control form-control-sm @error('sale_price') is-invalid @enderror" id="sale_price" name="sale_price" value="{{ $data['data']->sale_price }}">
                @error('sale_price')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <input type="text" class="form-control form-control-sm @error('shelf_no') is-invalid @enderror" id="shelf_no" name="shelf_no" value="{{ $data['data']->shelf_no }}">
                @error('shelf_no')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <input type="text" class="form-control form-control-sm @error('stock_alert') is-invalid @enderror" id="stock_alert" name="stock_alert" value="{{ $data['data']->stock_alert }}">
                @error('stock_alert')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-6 mt-3">
                ...
                <select class="form-control form-control-sm js-example-basic-single" name="type" id="type" onchange="getProductVariation()">
                    <option  value="">@lang('common.select_one')</option>
                   <option @if($data['data']->type == 1) selected @endif  value="1">@lang('product.simple')</option>
                   <option @if($data['data']->type == 2) selected @endif  value="2">@lang('product.variable')</option>
                </select>
                @error('type')
                    <div class="alert alert-danger">
                        {{ $message }}
            ...
            <div class="col-lg-12 col-md-12 col-12 mt-3" id="show_variation">
                ...
                $color = App\Models\Color::where('status',1)->where('store_id',$store_id)->get();
                $size = App\Models\Size::where('status',1)->where('store_id',$store_id)->get();
                ...
                @if(isset($color))
                    ...
                    <label>@lang('product.select_color')</label>
                    <div class="mt-2">
                    <div class="m-b-10">
                    @foreach($color as $c)
                        @php
                        ...
                        $product_color = App\Models\ProductColorInfo::where('product_id',$data['data']->product_id)->where('color_id',$c->id)->count();

                        @endphp
                        <label class="ui-checkbox ui-checkbox-inline">
                                <input type="checkbox" name="color[]" id="color" value="{{$c->id}}" @if($product_color == 1) checked @endif >
                ...
                @if(isset($size))
                    ...
                    <hr><label>@lang('product.select_size')</label>
                    <div class="mt-2">
                    <div class="m-b-10">
                    @foreach($size as $s)
                        @php
                        ...
                        $product_size = App\Models\ProductSizeInfo::where('product_id',$data['data']->product_id)->where('size_id',$s->id)->count();
                        @endphp
                        <label class="ui-checkbox ui-checkbox-inline">
                            <input type="checkbox" name="size[]" id="size" value="{{$s->id}}" @if($product_size == 1) checked @endif>
