...
<div class="page-content fade-in-up">
   ...
   <div class="card">
    <div class="card-header">
        <b>@lang('supplier_area.add')</b>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('supplier_area.store') }}">
            @csrf
            <div class="row">
                <div class="col-lg-4 col-md-6 col-6">
                    <label for="area_name">@lang('supplier_area.area_name')</label><span class="text-danger">*</span>
                    <input type="text" class="form-control form-control-sm @error('area_name') is-invalid @enderror" id="area_name" name="area_name" value="{{ old('area_name') }}">
                    @error('area_name')
