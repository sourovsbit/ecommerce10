...
<div class="page-content fade-in-up">
   ...
   <div class="card">
    <div class="card-header">
        <b>@lang('sub_unit.edit')</b>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('sub_unit.update',$data['data']->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <select class="form-control form-control-sm js-example-basic-single" name="unit_id" id="unit_id">
                        ...
                        <option @if($data['data']->unit_id == $i->id) selected @endif value="{{ $i->id }}">
                ...
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <input type="text" class="form-control form-control-sm @error('sub_unit_name') is-invalid @enderror" id="sub_unit_name" name="sub_unit_name" value="{{ $data['data']->sub_unit_name }}">
                    @error('sub_unit_name')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <input type="text" class="form-control form-control-sm @error('sub_unit_name_bn') is-invalid @enderror" id="sub_unit_name_bn" name="sub_unit_name_bn" value="{{ $data['data']->sub_unit_name_bn }}">
                ...
                <div class="col-lg-4 col-md-6 col-6 mt-2">
                    ...
                    <input type="text" class="form-control form-control-sm @error('sub_unit_data') is-invalid @enderror" id="sub_unit_data" name="sub_unit_data" value="{{ $data['data']->sub_unit_data }}">
                    @error('sub_unit_data')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
