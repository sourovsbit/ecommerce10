...
<div class="page-content fade-in-up">
   ...
   <div class="card">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('size.update',$data['data']->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-4 col-md-6 col-6">
                    <label for="size_name">@lang('size.size_name')</label><span class="text-danger">*</span>
                    <input type="text" class="form-control form-control-sm @error('size_name') is-invalid @enderror" id="size_name" name="size_name" value="{{ $data['data']->size_name }}">
                    @error('size_name')
