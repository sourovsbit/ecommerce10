...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('district_setup.edit_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('district_setup.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('district_name') is-invalid @enderror" name="district_name" id="district_name"  value="{{ $data['data']->district_name }}">
                        @error('district_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('district_name_bn') is-invalid @enderror" name="district_name_bn" id="district_name_bn"  value="{{ $data['data']->district_name_bn }}">
