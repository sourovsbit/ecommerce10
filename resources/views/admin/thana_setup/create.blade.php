...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('thana_setup.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm select2 @error('division_id') is-invalid @enderror" name="division_id" id="division_id" onchange="return GetDistrict()">
                                <option value="">@lang('common.select_one')</option>
                    ...
                    <div class="col-lg-3 col-md-12 col-12 mt-2">
                        <label>@lang('thana_setup.select_district')</label>
                        <div class="showlabels">
                    ...
                    <div class="col-lg-3 col-md-12 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('thana_name') is-invalid @enderror" name="thana_name" id="thana_name"  value="{{ old('thana_name') }}">
                        @error('thana_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('thana_name_bn') is-invalid @enderror" name="thana_name_bn" id="thana_name_bn"  value="{{ old('thana_name_bn') }}">
                        @error('thana_name_bn')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
