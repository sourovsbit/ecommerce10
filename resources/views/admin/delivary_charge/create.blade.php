...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('delivary_charge.create_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('delivary_charge.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm select2 @error('shipping_class_id') is-invalid @enderror" name="shipping_class_id" id="shipping_class_id">
                                ...
                                <option @if(old('shipping_class_id') == $shipping->id) selected @endif value="{{ $shipping->id }}">
                                    @if(config('app.locale') == 'en')
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="number" class="form-control form-control-sm @error('charge_amount') is-invalid @enderror" name="charge_amount" id="charge_amount"  value="{{ old('charge_amount') }}">
                        @error('charge_amount')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
