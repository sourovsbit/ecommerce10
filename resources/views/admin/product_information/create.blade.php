            ...
            <form method="post" action="{{route('product_information.store')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <textarea type="text" class="form-control form-control-sm @error('short_description') is-invalid @enderror" name="short_description"></textarea>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <textarea type="text" class="form-control form-control-sm @error('description') is-invalid @enderror" name="description"></textarea>
                        @error('description')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm select2 @error('product_type') is-invalid @enderror" name="product_type" id="product_type">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        <label>@lang('product_information.select_size')</label><span class="text-danger">*</span>
                        <div class="showlabels">
                            <div class="row">
                                @if(isset($data['size']))
                                @foreach ($data['size'] as $size)
                                    <div class="checkbox form-check col-lg-3 col-md-4 col-sm-6">
                                        <label>
                                            ...
                                            @if(config('app.locale') == 'en')
                                            {{ $size->size_name ?: $size->size_name_bn }}
                                            @else
                                            {{ $size->size_name_bn ?: $size->size_name }}
                                            @endif
                                        </label>
                                    </div>
                                @endforeach
