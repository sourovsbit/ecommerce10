                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-12 mt-4" id="size_box">
                                ...
                                <div class="showlabels">
                                    <div class="row">
                                        ...
                                        @php
                                        $check = App\Models\ProductSizeInfo::where('product_id',$data['data']->product_id)->where('size_id',$size->id)->first();
                                        @endphp
                                            <div class="checkbox form-check col-lg-3 col-md-4 col-sm-6 mt-2">
                                                <label>
                                                    <input type="checkbox" name="size_id[]" value="{{$size->id}}" @if(isset($check)) checked @endif>
                                                    @if(config('app.locale') == 'en')
