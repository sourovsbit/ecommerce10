...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('shipping_class.edit_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('shipping_class.update',$data['data']->id)}}">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('shipping_name') is-invalid @enderror" name="shipping_name" id="shipping_name"  value="{{ $data['data']->shipping_name }}">
                        @error('shipping_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('shipping_name_bn') is-invalid @enderror" name="shipping_name_bn" id="shipping_name_bn"  value="{{ $data['data']->shipping_name_bn }}">
