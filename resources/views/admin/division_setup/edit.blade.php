...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('division_setup.edit_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('division_setup.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        <label>@lang('division_setup.select_country')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('division_name') is-invalid @enderror" name="division_name" id="division_name" value="{{ $data['data']->division_name }}">
                        @error('division_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('division_name_bn') is-invalid @enderror" name="division_name_bn" id="division_name_bn" value="{{ $data['data']->division_name_bn }}">
